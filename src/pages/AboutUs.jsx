...
import './AboutUs.css'
import Ceo from  "../assets/CeoDaltech(2).jpg"
import DCeo from  "../assets/DeputyDaltech(2).jpg"
import Staff from  "../assets/Daltechstaff(2).jpg"
...
<div className="teamBars">
    ...
    <img src={Ceo} alt="Ceo" class="rounded" width="200" height="97" className="aboutImg"/> 
    ...
    <div className="teamBar">  
      ...
      <img src={DCeo} alt="DCeo" class="rounded" width="200" height="97" className="aboutImg"/> 
          <div className="teamBarText">
    ...
    <div className="teamBar">
    <img src={Staff} alt="Staff"class="rounded" width="200" height="97" className="aboutImg"/> 
          <div className="teamBarText">
